...
class TrainerModel(UUIDBase):
    ...
    is_active: Mapped[bool] = mapped_column(Boolean, default=False)
    date_joined_trainer: Mapped[Optional[datetime ]] = mapped_column(DateTime, nullable=True)
    date_left_trainer: Mapped[Optional[datetime ]] = mapped_column(DateTime, nullable=True)
